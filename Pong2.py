...
class Game:
    ...
    def start(self):
        """ This function will start a Pong game!
         :return: None
         """
        pygame.mixer.music.load(r"documents\jazz_bg.ogg")  # Initialize the background music
        ...
        while True:
            ...
            if self.ball.left_side():
                ...
                playsound(r'documents\what_a_loser.mp3')
            ...
            if self.ball.right_side():
                ...
                playsound(r'documents\You_sucks.mp3')
